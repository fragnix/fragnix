...
instance Storable Event where
    sizeOf    _ = (12)
{-# LINE 141 "GHC.Event.EPoll.hsc" #-}
    alignment _ = alignment (undefined :: CInt)

    peek ptr = do
        ets <- (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 145 "GHC.Event.EPoll.hsc" #-}
