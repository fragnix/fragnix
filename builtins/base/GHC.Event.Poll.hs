...
{-# LINE 174 "GHC.Event.Poll.hsc" #-}

{-# LINE 175 "GHC.Event.Poll.hsc" #-}
...
{-# LINE 197 "GHC.Event.Poll.hsc" #-}
      revents <- (\hsc_ptr -> peekByteOff hsc_ptr 6) ptr
{-# LINE 198 "GHC.Event.Poll.hsc" #-}
