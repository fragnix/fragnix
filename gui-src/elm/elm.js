...
{
	if (region.bc.ax === region.aZ.ax)
	{
		return 'on line ' + region.bc.ax;
	}
	return 'on lines ' + region.bc.ax + ' through ' + region.aZ.ax;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.A, request.be, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c9: 'hidden', cQ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c9: 'mozHidden', cQ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c9: 'msHidden', cQ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c9: 'webkitHidden', cQ: 'webkitvisibilitychange' }
		: { c9: 'hidden', cQ: 'visibilitychange' };
}
...
var author$project$API$apiUrl = 'http://localhost:8080';
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{ac: false, bn: r.bn, a_: r.a_, t: r.t, A: r.A, B: r.B, C: r.C, be: r.be}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{bn: elm$http$Http$emptyBody, a_: r.a_, t: _List_Nil, A: 'GET', B: elm$core$Maybe$Nothing, C: elm$core$Maybe$Nothing, be: r.be});
};
var author$project$API$getAllSlices = function (toMsg) {
	return elm$http$Http$get(
		{
			...
			be: author$project$API$apiUrl + '/contents'
		});
};
...
var author$project$Main$emptyModel = {
	...
	h: author$project$Main$Loading(_List_Nil),
	az: false,
	v: _List_Nil
};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		author$project$API$getAllSlices(author$project$Main$ReceivedSlices));
};
var author$project$API$httpErrorToString = function (err) {
	switch (err.$) {
		case 1:
...
var author$project$LocalSlice$LocalSliceID = elm$core$Basics$identity;
var author$project$LocalSlice$decodeLocalSliceID = A2(elm$json$Json$Decode$map, elm$core$Basics$identity, elm$json$Json$Decode$string);
var author$project$TupleHelper$decodeTuple = F2(
	function (first, second) {
		return A3(
			...
			A2(elm$json$Json$Decode$field, 'first', first),
			A2(elm$json$Json$Decode$field, 'second', second));
	});
var author$project$API$decodeUpdateMap = elm$json$Json$Decode$list(
	A2(author$project$TupleHelper$decodeTuple, author$project$LocalSlice$decodeLocalSliceID, elm$json$Json$Decode$string));
...
var author$project$LocalSlice$encodeFragment = function (_n0) {
	var lines = _n0;
	return A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, lines);
};
...
var author$project$LocalSlice$encodeLanguage = function (_n0) {
	var ghcexts = _n0;
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'extensions',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, ghcexts))
			]));
};
var author$project$LocalSlice$encodeInstancePart = function (part) {
	switch (part) {
		case 0:
			return elm$json$Json$Encode$string('OfThisClass');
		case 1:
			return elm$json$Json$Encode$string('OfThisClassForUnknownType');
		case 2:
			return elm$json$Json$Encode$string('ForThisType');
		default:
			return elm$json$Json$Encode$string('ForThisTypeOfUnknownClass');
	}
};
var author$project$LocalSlice$encodeLocalSliceID = function (_n0) {
	var sid = _n0;
	return elm$json$Json$Encode$string(sid);
};
var author$project$LocalSlice$encodeLocalInstance = function (inst) {
	if (!inst.$) {
		var iPart = inst.a;
		var localInstId = inst.b;
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'instancePart',
					author$project$LocalSlice$encodeInstancePart(iPart)),
					_Utils_Tuple2(
					'localInstanceID',
					author$project$LocalSlice$encodeLocalSliceID(localInstId))
				]));
	} else {
		var iPart = inst.a;
		var globalInstId = inst.b;
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					...
					_Utils_Tuple2(
					'globalInstanceID',
					elm$json$Json$Encode$string(globalInstId))
				]));
	}
};
var author$project$LocalSlice$encodeLocalReference = function (ref) {
	switch (ref.$) {
		case 0:
			var sid = ref.a;
			return elm$json$Json$Encode$object(
		...
		case 1:
			var originalModule = ref.a;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'builtinModule',
						elm$json$Json$Encode$string(originalModule))
					]));
		default:
			var sid = ref.a;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'otherLocalSlice',
						author$project$LocalSlice$encodeLocalSliceID(sid))
					]));
	}
};
var elm$json$Json$Encode$null = _Json_encodeNull;
var author$project$LocalSlice$encodeQualification = function (qual) {
	if (qual.$ === 1) {
...
var author$project$LocalSlice$encodeName = function (n) {
	if (!n.$) {
		var i = n.a;
		return elm$json$Json$Encode$object(
			_List_fromArray(
...
var author$project$LocalSlice$encodeUsedName = function (uname) {
	switch (uname.$) {
		case 0:
			var n = uname.a;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'valueName',
						author$project$LocalSlice$encodeName(n))
					]));
		case 1:
			var n = uname.a;
			return elm$json$Json$Encode$object(
			...
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'constructorTypeName',
						author$project$LocalSlice$encodeName(typeN)),
						_Utils_Tuple2(
						'constructorName',
						author$project$LocalSlice$encodeName(n))
					]));
...
var author$project$LocalSlice$encodeLocalUse = function (_n0) {
	var qual = _n0.a;
	var usedName = _n0.b;
	var localRef = _n0.c;
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'qualification',
				author$project$LocalSlice$encodeQualification(qual)),
				_Utils_Tuple2(
				'usedName',
				author$project$LocalSlice$encodeUsedName(usedName)),
				_Utils_Tuple2(
				'localReference',
				author$project$LocalSlice$encodeLocalReference(localRef))
			]));
};
var author$project$LocalSlice$encodeLocalSlice = function (_n0) {
	var sid = _n0.a;
	var lang = _n0.b;
	var frag = _n0.c;
	var uses = _n0.d;
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'language',
				author$project$LocalSlice$encodeLanguage(lang)),
				_Utils_Tuple2(
				'fragment',
				author$project$LocalSlice$encodeFragment(frag)),
				_Utils_Tuple2(
				'localUses',
				A2(elm$json$Json$Encode$list, author$project$LocalSlice$encodeLocalUse, uses)),
				_Utils_Tuple2(
				'localInstances',
				A2(elm$json$Json$Encode$list, author$project$LocalSlice$encodeLocalInstance, instances))
			]));
};
var author$project$TupleHelper$encodeTuple = F2(
	function (first, second) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2('first', first),
					_Utils_Tuple2('second', second)
				]));
	});
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{bn: r.bn, a_: r.a_, t: _List_Nil, A: 'POST', B: elm$core$Maybe$Nothing, C: elm$core$Maybe$Nothing, be: r.be});
};
var author$project$API$saveSlices = F3(
	function (toMsg, obsoletes, localSlices) {
		return elm$http$Http$post(
			{
				bn: elm$http$Http$jsonBody(
					A2(
						author$project$TupleHelper$encodeTuple,
						A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, obsoletes),
						A2(elm$json$Json$Encode$list, author$project$LocalSlice$encodeLocalSlice, localSlices))),
				a_: A2(
					elm$http$Http$expectJson,
					toMsg,
					A2(
						author$project$TupleHelper$decodeTuple,
						author$project$API$decodeUpdateMap,
						elm$json$Json$Decode$list(author$project$Slice$sliceDecoder))),
				be: author$project$API$apiUrl + '/save'
			});
	});
var author$project$Editor$Expanded = function (a) {
	return {$: 1, a: a};
};
var author$project$Editor$Collapsed = {$: 0};
var author$project$Editor$collapseNode = function (node) {
	return elm$core$Result$Ok(
		_Utils_update(
			node,
			{i: author$project$Editor$Collapsed}));
};
var author$project$Editor$combineResults = A2(
	elm$core$List$foldl,
	F2(
		function (x, acc) {
			if (acc.$ === 1) {
...
var author$project$Editor$Dependencies = function (a) {
	return {$: 2, a: a};
};
var author$project$Editor$Occurences = function (a) {
	return {$: 1, a: a};
};
var author$project$Editor$SliceNode = function (a) {
	return {$: 0, a: a};
};
var author$project$Editor$defaultNode = {
	i: author$project$Editor$Collapsed,
	p: author$project$Editor$Occurences(_List_Nil),
	av: false,
	ag: false,
	ai: false,
	j: '',
...
var author$project$Editor$fetch = F2(
	function (cache, sid) {
...
var author$project$Editor$fetchMap = F2(
	function (cache, sids) {
		return A2(
			elm$core$Result$mapError,
			function (x) {
			...
			author$project$Editor$combineResults(
				A2(
					elm$core$List$map,
					author$project$Editor$fetch(cache),
					sids)));
	});
var author$project$Editor$tupleCombineResults = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
...
var author$project$Editor$expandNode = F2(
	function (cache, node) {
		if (!_Utils_eq(node.i, author$project$Editor$Collapsed)) {
					...
					return A2(
						...
						function (_n1) {
							...
							return _Utils_update(
								node,
								{
									i: author$project$Editor$Expanded(
										_List_fromArray(
											[
												_Utils_update(
												author$project$Editor$defaultNode,
												{
													p: author$project$Editor$Occurences(occs),
													j: node.j + 'occ'
												}),
												_Utils_update(
												author$project$Editor$defaultNode,
												{
													p: author$project$Editor$Dependencies(deps),
													j: node.j + 'dep'
												})
											]))
								});
						},
						author$project$Editor$tupleCombineResults(
							_Utils_Tuple2(
								A2(author$project$Editor$fetchMap, cache, sw.dw),
								A2(
									author$project$Editor$fetchMap,
									cache,
									author$project$Slice$extractDependencies(sw.bb)))));
				case 1:
					var occs = _n0.a;
					return elm$core$Result$Ok(
						_Utils_update(
									...
									A2(
										...
										function (sw) {
											return _Utils_update(
												author$project$Editor$defaultNode,
												{
													p: author$project$Editor$SliceNode(sw),
													j: _Utils_ap(node.j, sw.j)
												});
										},
										occs))
							}));
...
var author$project$Editor$nodeUpdate = F3(
	function (action, cache, node) {
		if (A2(elm$core$String$startsWith, node.j, action.w)) {
			if (_Utils_eq(node.j, action.w)) {
				var _n2 = action.x;
				switch (_n2) {
					case 2:
						return elm$core$Result$Ok(
					...
					case 5:
						return elm$core$Result$Ok(
							_Utils_update(
								...
								{ai: false}));
					case 0:
						return A2(author$project$Editor$expandNode, cache, node);
					case 1:
						return author$project$Editor$collapseNode(node);
					case 6:
						return elm$core$Result$Ok(
							_Utils_update(
								node,
				...
				return A3(author$project$Editor$propagateUpdate, action, cache, node);
			}
		} else {
			return elm$core$Result$Ok(node);
		}
	});
var author$project$Editor$propagateUpdate = F3(
	function (action, cache, node) {
		var _n0 = node.i;
		if (!_n0.$) {
			return elm$core$Result$Ok(node);
			...
			var cs = _n0.a;
			var _n1 = author$project$Editor$combineResults(
				A2(
					elm$core$List$map,
					A2(author$project$Editor$nodeUpdate, action, cache),
					cs));
			if (!_n1.$) {
				var newNodes = _n1.a;
				return elm$core$Result$Ok(
					_Utils_update(
						node,
						{
							i: author$project$Editor$Expanded(newNodes)
						}));
			} else {
				var errs = _n1.a;
				return elm$core$Result$Err(
...
var author$project$Main$HashedSlices = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$IndexSlices = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$LoadingStep = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$TreeView = function (a) {
	return {$: 1, a: a};
};
var author$project$LocalSlice$LocalSlice = F5(
	function (a, b, c, d, e) {
		return {$: 0, a: a, b: b, c: c, d: d, e: e};
	});
var author$project$LocalSlice$GlobalInstance = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var author$project$LocalSlice$LocalInstance = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var author$project$LocalSlice$toLocalInstances = function (locals) {
	return elm$core$List$map(
		function (_n0) {
			var part = _n0.a;
			var sid = _n0.b;
			return A2(elm$core$Set$member, sid, locals) ? A2(author$project$LocalSlice$LocalInstance, part, sid) : A2(author$project$LocalSlice$GlobalInstance, part, sid);
		});
};
var author$project$LocalSlice$Builtin = function (a) {
	return {$: 1, a: a};
};
var author$project$LocalSlice$LocalUse = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var author$project$LocalSlice$OtherLocalSlice = function (a) {
	return {$: 2, a: a};
};
var author$project$LocalSlice$OtherSlice = function (a) {
	return {$: 0, a: a};
};
var author$project$LocalSlice$toLocalUse = F2(
	function (locals, _n0) {
		var qual = _n0.a;
		var usedName = _n0.b;
		var ref = _n0.c;
		return A3(
			author$project$LocalSlice$LocalUse,
			qual,
			usedName,
			function () {
				if (!ref.$) {
					var sid = ref.a;
					return A2(elm$core$Set$member, sid, locals) ? author$project$LocalSlice$OtherLocalSlice(sid) : author$project$LocalSlice$OtherSlice(sid);
				} else {
					var mod = ref.a;
					return author$project$LocalSlice$Builtin(mod);
				}
			}());
	});
var author$project$LocalSlice$toLocalUses = F2(
	function (locals, uses) {
		return A2(
			elm$core$List$map,
			author$project$LocalSlice$toLocalUse(locals),
			uses);
	});
var author$project$LocalSlice$sliceToLocalSlice = F2(
	function (_n0, locals) {
		var sid = _n0.a;
		var lang = _n0.b;
		var frag = _n0.c;
		...
		var instances = _n0.e;
		return A5(
			author$project$LocalSlice$LocalSlice,
			sid,
			lang,
			frag,
			A2(author$project$LocalSlice$toLocalUses, locals, uses),
			A2(author$project$LocalSlice$toLocalInstances, locals, instances));
	});
...
var author$project$LocalSlice$toLocalSlice = function (_n0) {
	var slice = _n0.bb;
	var origin = _n0.dF;
	var locals = _n0.dq;
	if (!origin.$) {
		return elm$core$Set$isEmpty(locals) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
			A2(author$project$LocalSlice$sliceToLocalSlice, slice, locals));
	} else {
		return elm$core$Maybe$Just(
			A2(author$project$LocalSlice$sliceToLocalSlice, slice, locals));
	}
};
var author$project$Main$insertOne = F3(
	function (key, newValue, queue) {
		var _n0 = A2(elm$core$Dict$get, key, queue);
		if (_n0.$ === 1) {
			return A3(
				elm$core$Dict$insert,
				key,
				A2(elm$core$Set$insert, newValue, elm$core$Set$empty),
				queue);
		} else {
			var set = _n0.a;
			return A3(
				elm$core$Dict$insert,
				key,
				A2(elm$core$Set$insert, newValue, set),
				queue);
		}
	});
var author$project$Main$insertAll = F3(
	function (places, sid, queue) {
		return A3(
			elm$core$List$foldl,
			F2(
				function (place, newQueue) {
					return A3(author$project$Main$insertOne, place, sid, newQueue);
				}),
			queue,
			places);
	});
var author$project$Slice$Disk = {$: 0};
var elm$core$Basics$not = _Basics_not;
var author$project$Slice$hasChanged = function (_n0) {
	var origin = _n0.dF;
	var locals = _n0.dq;
	return !(_Utils_eq(origin, author$project$Slice$Disk) && elm$core$Set$isEmpty(locals));
};
...
var author$project$Main$dirtyStep = F3(
	function (sw, changedReferences, queue) {
		return _Utils_Tuple2(
			_Utils_update(
				sw,
				{
					dq: A2(elm$core$Set$union, changedReferences, sw.dq)
				}),
			(!author$project$Slice$hasChanged(sw)) ? A3(author$project$Main$insertAll, sw.dw, sw.j, queue) : queue);
	});
var author$project$Main$walkSlices = F3(
	function (step, queue, cache) {
		walkSlices:
		while (true) {
			var _n0 = elm$core$Dict$keys(queue);
			if (!_n0.b) {
				return cache;
			} else {
				var x = _n0.a;
				var _n1 = _Utils_Tuple2(
					A2(elm$core$Dict$get, x, cache),
					A2(elm$core$Dict$get, x, queue));
				if ((!_n1.a.$) && (!_n1.b.$)) {
					var sw = _n1.a.a;
					var pending = _n1.b.a;
					var _n2 = A3(
						...
						sw,
						pending,
						A2(elm$core$Dict$remove, x, queue));
					var newSw = _n2.a;
					var newQueue = _n2.b;
					var $temp$step = step,
						$temp$queue = newQueue,
						$temp$cache = A3(elm$core$Dict$insert, x, newSw, cache);
					step = $temp$step;
					queue = $temp$queue;
					cache = $temp$cache;
					continue walkSlices;
					...
					var $temp$step = step,
						$temp$queue = A2(elm$core$Dict$remove, x, queue),
						$temp$cache = cache;
					step = $temp$step;
					queue = $temp$queue;
					cache = $temp$cache;
...
var author$project$Main$computeLocalSlices = F2(
	function (slices, cache) {
		var changedSlices = A2(
			elm$core$List$filter,
			function (sw) {
				return !_Utils_eq(sw.dF, author$project$Slice$Disk);
			},
			slices);
		var initQueue = A3(
			elm$core$List$foldl,
			F2(
				function (x, acc) {
					return A3(author$project$Main$insertAll, x.dw, x.j, acc);
				}),
			elm$core$Dict$empty,
			changedSlices);
		var newCache = A3(author$project$Main$walkSlices, author$project$Main$dirtyStep, initQueue, cache);
		var newSlices = elm$core$Dict$values(newCache);
		return _Utils_Tuple2(
			A2(
				elm$core$List$filterMap,
				function (sw) {
					return author$project$Slice$hasChanged(sw) ? elm$core$Maybe$Just(sw.j) : elm$core$Maybe$Nothing;
				},
				newSlices),
			A2(elm$core$List$filterMap, author$project$LocalSlice$toLocalSlice, newSlices));
	});
var author$project$Editor$mapNode = F2(
	function (f, node) {
		var _n0 = node.i;
		if (!_n0.$) {
			return f(node);
				...
				_Utils_update(
					node,
					{
						i: author$project$Editor$Expanded(
							A2(
								elm$core$List$map,
								author$project$Editor$mapNode(f),
								nodes))
					}));
		}
	});
...
var author$project$Editor$updateNodeContents = F2(
	function (updates, node) {
		var dict = elm$core$Dict$fromList(updates);
		var updateSw = function (sw) {
			var _n1 = A2(elm$core$Dict$get, sw.j, dict);
			if (!_n1.$) {
				var newSw = _n1.a;
				return newSw;
			} else {
				...
				switch (_n0.$) {
					case 0:
						...
						return _Utils_update(
							n,
							{
								p: author$project$Editor$SliceNode(
									updateSw(sw))
							});
					case 1:
						var occs = _n0.a;
						return _Utils_update(
							n,
							{
								p: author$project$Editor$Occurences(
									A2(elm$core$List$map, updateSw, occs))
							});
					default:
						var deps = _n0.a;
						return _Utils_update(
							n,
							{
								p: author$project$Editor$Dependencies(
									A2(elm$core$List$map, updateSw, deps))
							});
				}
			},
			node);
	});
var author$project$Main$exchangeSliceWrap = F3(
	function (model, target, changed) {
		var updates = _List_fromArray(
			[
				_Utils_Tuple2(target.j, changed)
			]);
		var newPage = function () {
			var _n0 = model.h;
			if (_n0.$ === 1) {
				var node = _n0.a;
				return author$project$Main$TreeView(
					A2(author$project$Editor$updateNodeContents, updates, node));
			} else {
				return model.h;
			}
		}();
		var newCache = A3(elm$core$Dict$insert, target.j, changed, model.n);
		return _Utils_update(
			model,
			{
				n: newCache,
				h: newPage,
				v: elm$core$Dict$values(newCache)
			});
	});
...
var author$project$Slice$changeText = F2(
	function (codes, sw) {
		var _n0 = sw.bb;
		var sid = _n0.a;
		var lang = _n0.b;
		var uses = _n0.d;
		var instances = _n0.e;
		var lines = elm$core$String$lines(codes);
		var newSlice = A5(author$project$Slice$Slice, sid, lang, lines, uses, instances);
...
var author$project$Slice$ChangedFrom = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var author$project$Slice$Name = 2;
var author$project$Slice$Refactor = 0;
var author$project$Slice$Signature = 1;
var author$project$Slice$renderFragment = function (slice) {
	var codes = slice.c;
	return elm$core$String$concat(
...
var author$project$Slice$computeChangeKinds = F2(
	function (oldS, _new) {
		var old = function () {
			var _n0 = _new.dF;
			if (_n0.$ === 1) {
		...
		var changes = _Utils_ap(
			_List_Nil,
			_Utils_ap(
				_Utils_eq(
					author$project$Slice$renderFragment(old.bb),
					author$project$Slice$renderFragment(_new.bb)) ? _List_Nil : _List_fromArray(
					[0]),
				_Utils_ap(
					_Utils_eq(old.aB, _new.aB) ? _List_Nil : _List_fromArray(
						[1]),
					_Utils_eq(old.du, _new.du) ? _List_Nil : _List_fromArray(
						[2]))));
		return elm$core$List$isEmpty(changes) ? old : _Utils_update(
			_new,
			{
				dF: A2(author$project$Slice$ChangedFrom, old, changes)
			});
	});
var author$project$Main$editUpdate = F3(
	function (txt, sw, model) {
		return A3(
			author$project$Main$exchangeSliceWrap,
			model,
			sw,
			A2(
				author$project$Slice$computeChangeKinds,
				sw,
				A2(author$project$Slice$changeText, txt, sw)));
	});
		...
		if (_n0.$ === 1) {
			...
			return A3(
				...
				_Utils_update(
					sw,
					{
						dw: A2(elm$core$List$cons, occId, sw.dw)
					}),
				dict);
		}
	});
...
var author$project$Main$computeOccurences = function (model) {
	var fullCache = A3(elm$core$List$foldl, author$project$Main$addOccurences, model.n, model.v);
	var fullSlices = elm$core$Dict$values(fullCache);
	return _Utils_update(
		model,
		{n: fullCache, v: fullSlices});
};
var author$project$Main$dictRemoveList = F2(
	function (list, dict) {
		return A3(
			elm$core$List$foldl,
			F2(
				function (k, acc) {
					return A2(elm$core$Dict$remove, k, acc);
				}),
			dict,
			list);
	});
var author$project$Main$insertSliceWraps = F2(
	function (sws, cache) {
		return A3(
			elm$core$List$foldl,
			F2(
				function (sw, acc) {
					return A3(elm$core$Dict$insert, sw.j, sw, acc);
				}),
			cache,
			sws);
	});
...
var author$project$Main$integrityCheck = F2(
	function (cache, slices) {
		return A2(
			elm$core$Result$mapError,
			author$project$Main$missingSlicesToString,
			A3(
				elm$core$List$foldl,
				author$project$Main$checkDependencies(cache),
				elm$core$Result$Ok(0),
				slices));
	});
var author$project$Main$performIntegrityCheck = function (model) {
	var _n0 = A2(author$project$Main$integrityCheck, model.n, model.v);
	if (!_n0.$) {
		return model;
	} else {
		var err = _n0.a;
...
var author$project$Main$integrateHashedSlices = F3(
	function (umap, slices, model) {
		var updateMap = A2(
			elm$core$List$map,
			...
			umap);
		var sliceWraps = A2(elm$core$List$map, author$project$Slice$wrap, slices);
		var newCache = A2(
			elm$core$Dict$map,
			F2(
				function (k, sw) {
			...
			A2(
				author$project$Main$insertSliceWraps,
				sliceWraps,
				A2(
					author$project$Main$dictRemoveList,
					A2(elm$core$List$map, elm$core$Tuple$first, updateMap),
					model.n)));
		var newModel = author$project$Main$computeOccurences(
			_Utils_update(
				model,
				{
					n: newCache,
		...
		var nodeUpdates = A2(
			...
			function (_n1) {
				...
				return A2(
					elm$core$Maybe$map,
					function (sw) {
						return _Utils_Tuple2(old, sw);
					},
					A2(elm$core$Dict$get, sid, newModel.n));
			},
			updateMap);
		var newPage = function () {
			var _n0 = newModel.h;
			if (_n0.$ === 1) {
				var node = _n0.a;
				return author$project$Main$TreeView(
					A2(author$project$Editor$updateNodeContents, nodeUpdates, node));
			} else {
				return newModel.h;
			}
		}();
...
var author$project$Main$CheckIntegrity = {$: 2};
var author$project$Main$ComputeOccurences = {$: 1};
var author$project$Main$FindMain = {$: 3};
...
var author$project$Main$indexSlices = function (model) {
	return _Utils_update(
		model,
		{
			n: A2(author$project$Main$insertSliceWraps, model.v, model.n)
		});
};
var author$project$Main$insertSlices = F2(
	function (newSlices, model) {
		return _Utils_update(
			model,
			{
				v: A2(elm$core$List$map, author$project$Slice$wrap, newSlices)
			});
	});
...
var author$project$Main$perform = F2(
	function (toMsg, content) {
		return A2(
			...
			A2(
				elm$core$Task$andThen,
				function (_n0) {
					return elm$core$Task$succeed(content);
				},
				elm$core$Process$sleep(1)));
	});
var author$project$Main$defaultNode = author$project$Editor$defaultNode;
...
var author$project$Main$setRoot = function (model) {
	var rsw = function () {
		var _n1 = model.ay;
		if (_n1.$ === 1) {
			return elm$core$List$head(model.v);
		} else {
			var y = _n1.a;
			return A2(elm$core$Dict$get, y, model.n);
		}
	}();
	if (rsw.$ === 1) {
		return _Utils_update(
			model,
			{
				s: elm$core$Maybe$Just('No slices found')
			});
	} else {
		var sw = rsw.a;
		return _Utils_update(
			model,
			{
				h: author$project$Main$TreeView(
					_Utils_update(
...
var author$project$Main$loadingUpdate = F2(
	function (step, model) {
		var _n0 = model.h;
		if (!_n0.$) {
			var msgs = _n0.a;
			switch (step.$) {
				case 0:
					...
					return _Utils_Tuple2(
						...
						A2(author$project$Main$perform, author$project$Main$LoadingStep, author$project$Main$ComputeOccurences));
				case 1:
					return _Utils_Tuple2(
						...
						A2(author$project$Main$perform, author$project$Main$LoadingStep, author$project$Main$CheckIntegrity));
				case 2:
					return _Utils_Tuple2(
						...
						A2(author$project$Main$perform, author$project$Main$LoadingStep, author$project$Main$FindMain));
				default:
					return _Utils_Tuple2(
						author$project$Main$setRoot(
							author$project$Main$findMain(model)),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						s: elm$core$Maybe$Just('Trying to load slices but not in a loading state')
					}),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
						...
						_Utils_update(
							model,
							{
								s: elm$core$Maybe$Just(
									author$project$API$httpErrorToString(e))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var slices = result.a;
								...
								model,
								{
									h: author$project$Main$Loading(
										_Utils_ap(
											msgs,
											_List_fromArray(
												['Received Slices. Indexing...'])))
								}),
							A2(
								author$project$Main$perform,
								function (x) {
									return author$project$Main$LoadingStep(
										author$project$Main$IndexSlices(x));
								},
								slices));
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									s: elm$core$Maybe$Just('Received Slices but was not in a loading state.')
								}),
							elm$core$Platform$Cmd$none);
					}
				}
			case 3:
				var step = msg.a;
				return A2(author$project$Main$loadingUpdate, step, model);
			case 4:
				var err = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 10:
				...
				var sw = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Main$editUpdate, txt, sw, model),
					elm$core$Platform$Cmd$none);
			case 9:
				var editorMsg = msg.a;
				if (!editorMsg.$) {
					var mainAction = editorMsg.a;
					var txt = mainAction.a;
					var sw = mainAction.b;
					return _Utils_Tuple2(
						A3(author$project$Main$editUpdate, txt, sw, model),
						elm$core$Platform$Cmd$none);
				} else {
					var editorAction = editorMsg.a;
					var _n5 = model.h;
					if (_n5.$ === 1) {
						var r = _n5.a;
						var _n6 = A3(author$project$Editor$nodeUpdate, editorAction, model.n, r);
						if (!_n6.$) {
							var newRoot = _n6.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										h: author$project$Main$TreeView(newRoot)
									}),
								elm$core$Platform$Cmd$none);
						} else {
							var err = _n6.a;
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									s: elm$core$Maybe$Just('How the heck did I get here? I was asked to manipulate a TreeView Page but it does not seem to exist.')
								}),
							elm$core$Platform$Cmd$none);
					}
				}
			case 7:
				var _n7 = A2(author$project$Main$computeLocalSlices, model.v, model.n);
				var obsoletes = _n7.a;
				var localSlices = _n7.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{az: true}),
					A3(author$project$API$saveSlices, author$project$Main$HashedSlices, obsoletes, localSlices));
			case 1:
				var result = msg.a;
				if (result.$ === 1) {
					var e = result.a;
					...
					return _Utils_Tuple2(
						A3(
							author$project$Main$integrateHashedSlices,
							updateMap,
							newSlices,
							_Utils_update(
								model,
...
var author$project$EditorField$monokai_colors_css = '.elmsh {color: #f8f8f2;}.elmsh-hl {background: #343434;}.elmsh-add {background: #003800;}.elmsh-del {background: #380000;}.elmsh-comm {color: #75715e;}.elmsh1 {color: #ae81ff;}.elmsh2 {color: #e6db74;}.elmsh3 {color: #f92672;}.elmsh4 {color: #66d9ef;}.elmsh5 {color: #a6e22e;}.elmsh6 {color: #ae81ff;}.elmsh7 {color: #fd971f;}.elmsh-elm-ts, .elmsh-js-dk, .elmsh-css-p {font-style: italic;color: #66d9ef;}.elmsh-js-ce {font-style: italic;color: #a6e22e;}.elmsh-css-ar-i {font-weight: bold;color: #f92672;}';
var author$project$EditorField$reference_css = '.reference {text-decoration: underline;}.reference:hover {cursor:pointer;}';
var author$project$EditorField$show_caret_css = 'textarea {caret-color: white;}';
var author$project$EditorField$css = _Utils_ap(
	author$project$EditorField$monokai_colors_css,
	_Utils_ap(author$project$EditorField$show_caret_css, author$project$EditorField$reference_css));
...
var author$project$Main$options = _List_fromArray(
	[
		...
		{cD: elm$core$Maybe$Nothing, cI: elm$core$Maybe$Nothing, dV: elm$core$Maybe$Nothing})
	]);
...
var mdgriffith$elm_ui$Internal$Style$classes = {co: 'a', aT: 'atv', cs: 'ab', ct: 'cx', cu: 'cy', cv: 'acb', cw: 'accx', cx: 'accy', cy: 'acr', bk: 'al', bl: 'ar', cz: 'at', aU: 'ah', aV: 'av', cB: 's', cF: 'bh', cG: 'b', cH: 'w7', cJ: 'bd', cK: 'bdt', aH: 'bn', cL: 'bs', aI: 'cpe', cR: 'cp', cS: 'cpx', cT: 'cpy', M: 'c', aK: 'ctr', aL: 'cb', aM: 'ccx', N: 'ccy', au: 'cl', aN: 'cr', cV: 'ct', cX: 'cptr', cY: 'ctxt', c6: 'fcs', by: 'focus-within', c7: 'fs', c8: 'g', a0: 'hbh', a1: 'hc', bC: 'he', a2: 'hf', bD: 'hfp', db: 'hv', dd: 'ic', df: 'fr', di: 'iml', dj: 'imlf', dk: 'imlp', dl: 'implw', dm: 'it', $7: 'i', bP: 'lnk', al: 'nb', bT: 'notxt', dy: 'ol', dA: 'or', Z: 'oq', dG: 'oh', h: 'pg', bW: 'p', dH: 'ppe', dO: 'ui', b8: 'r', dQ: 'sb', dR: 'sbx', dS: 'sby', dT: 'sbt', dW: 'e', dX: 'cap', dY: 'sev', d2: 'sk', ee: 't', ef: 'tc', eg: 'w8', eh: 'w2', ei: 'w9', ej: 'tj', aQ: 'tja', ek: 'tl', el: 'w3', em: 'w5', en: 'w4', eo: 'tr', ep: 'w6', eq: 'w1', er: 'tun', ch: 'ts', aa: 'clr', ex: 'u', bf: 'wc', cl: 'we', bg: 'wf', cm: 'wfp', bh: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.M);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.c8);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.h);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bW);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b8);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dW);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.G)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dZ.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dZ.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.b8) + ('-' + (elm$core$String$fromInt(pos.bs) + ('-' + (elm$core$String$fromInt(pos.aq) + ('-' + elm$core$String$fromInt(pos.ah)))))));
		case 11:
...
var mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.by) + ':focus-within',
			A2(
				elm$core$List$filterMap,
				elm$core$Basics$identity,
				_List_fromArray(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.aa)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.db, mdgriffith$elm_ui$Internal$Style$classes.Z)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.c6, mdgriffith$elm_ui$Internal$Style$classes.aa)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.c6, mdgriffith$elm_ui$Internal$Style$classes.Z)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aT, mdgriffith$elm_ui$Internal$Style$classes.aa)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aT, mdgriffith$elm_ui$Internal$Style$classes.Z)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cB) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.b8) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cB) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cB) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.b8) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cB) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.aK) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$inputTextReset + (mdgriffith$elm_ui$Internal$Style$sliderReset + (mdgriffith$elm_ui$Internal$Style$trackReset + (mdgriffith$elm_ui$Internal$Style$thumbReset + mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
var mdgriffith$elm_ui$Internal$Style$Intermediate = elm$core$Basics$identity;
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aJ: closing, q: _List_Nil, Q: _List_Nil, J: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								q: A2(
									elm$core$List$cons,
									{aJ: '\n}', q: _List_Nil, Q: props, J: '@supports (' + (prop + (':' + (value + (') {' + parent.J))))},
									rendered.q)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.J + ('{' + (renderValues(rule.Q) + (rule.aJ + '}')));
		}
	};
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							...
							'-ms-grid-column-span: ' + (elm$core$String$fromInt(position.aq) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							...
							'grid-column: ' + (elm$core$String$fromInt(position.bs) + (' / ' + (elm$core$String$fromInt(position.bs + position.aq) + ';')))
						]));
				var _class = '.grid-pos-' + (elm$core$String$fromInt(position.b8) + ('-' + (elm$core$String$fromInt(position.bs) + ('-' + (elm$core$String$fromInt(position.aq) + ('-' + elm$core$String$fromInt(position.ah)))))));
	...
	function (fontToAdjust, _n0, otherFontName) {
		...
		return A2(
			...
			_Utils_ap(
				...
				A3(mdgriffith$elm_ui$Internal$Model$fontRule, name, mdgriffith$elm_ui$Internal$Style$classes.c7, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.dX + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.ee + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.dX + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.ee)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {ah: height / size, ba: size, cj: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cP, adjustment.cE, adjustment.c0, adjustment.dr]);
	var lineHeight = 1.5;
	...
	function (_static, opts, styles, children) {
		var dynamicStyleSheet = A2(
			...
			A3(
				...
				_Utils_Tuple2(
					elm$core$Set$empty,
					mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.c6)),
				styles).b);
		return _static ? A2(
			elm$core$List$cons,
			_Utils_Tuple2(
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dW))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.aK, mdgriffith$elm_ui$Internal$Style$classes.N, mdgriffith$elm_ui$Internal$Style$classes.cy])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.aK, mdgriffith$elm_ui$Internal$Style$classes.N, mdgriffith$elm_ui$Internal$Style$classes.cw])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.aK, mdgriffith$elm_ui$Internal$Style$classes.cx])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.aK, mdgriffith$elm_ui$Internal$Style$classes.cv])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var mdgriffith$elm_ui$Internal$Model$textElementClasses = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.ee + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.bf + (' ' + mdgriffith$elm_ui$Internal$Style$classes.a1)))));
...
var mdgriffith$elm_ui$Internal$Model$textElementFillClasses = mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.ee + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + mdgriffith$elm_ui$Internal$Style$classes.a2)))));
...
var mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.dc, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.ea : _Utils_ap(styled.ea, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.dc, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.ea : _Utils_ap(styled.ea, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _n1.a;
			var styles = _n1.b;
			var newStyles = elm$core$List$isEmpty(styles) ? rendered.ea : _Utils_ap(rendered.ea, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.al, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.co]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.al, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.cG]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.al, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.dA]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.al, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.dy]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.al, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.df]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.al, mdgriffith$elm_ui$Internal$Style$classes.dW, mdgriffith$elm_ui$Internal$Style$classes.cF]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.dc, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bk);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bl);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ct);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cz);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cs);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cu);
	}
};
	...
	switch (h.$) {
		case 0:
			...
			return _Utils_Tuple3(
				...
				mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + name),
				_List_fromArray(
					[
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.cB + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.M + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
						mdgriffith$elm_ui$Internal$Style$classes.cB + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.b8 + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
						...
						if (A2(mdgriffith$elm_ui$Internal$Flag$present, mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									var name = 'height-px-' + val;
									var $temp$classes = mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + (name + (' ' + classes))),
										$temp$node = node,
									...
									continue gatherAttrRecursive;
								case 1:
									var $temp$classes = mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + classes),
										$temp$node = node,
										$temp$has = A2(
										mdgriffith$elm_ui$Internal$Flag$add,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.ea);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 1:
					...
					if (_n5.$ === 1) {
						return _Utils_update(
							record,
							{
								c6: elm$core$Maybe$Just(focusStyle)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{c6: elm$core$Maybe$Nothing, db: elm$core$Maybe$Nothing, dt: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.dO, mdgriffith$elm_ui$Internal$Style$classes.cB, mdgriffith$elm_ui$Internal$Style$classes.dW]))),
...
var mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.au + (' ' + mdgriffith$elm_ui$Internal$Style$classes.N)),
				A2(
					elm$core$List$cons,
			...
			_List_fromArray(
				[
					...
					A3(
						...
						_List_fromArray(
							[
								elm$html$Html$text(author$project$EditorField$css)
							]))),
					el
				])));
};
var author$project$Main$CloseError = {$: 5};
var mdgriffith$elm_ui$Element$rgb255 = F3(
	function (red, green, blue) {
		return A4(mdgriffith$elm_ui$Internal$Model$Rgba, red / 255, green / 255, blue / 255, 1);
	});
var author$project$Palette$monokai_black = A3(mdgriffith$elm_ui$Element$rgb255, 35, 36, 31);
var author$project$Palette$monokai_white = A3(mdgriffith$elm_ui$Element$rgb255, 247, 247, 241);
...
var author$project$Main$basicLayout = function (elem) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(author$project$Palette$monokai_black),
				mdgriffith$elm_ui$Element$Font$color(author$project$Palette$monokai_white),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill)
			]),
		elem);
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.cV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.au)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var mdgriffith$elm_ui$Element$pointer = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$cursor, mdgriffith$elm_ui$Internal$Style$classes.cX);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.N + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.dT + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bT)))))),
						A2(
							elm$core$List$cons,
...
var author$project$Main$viewErrMsg = function (err) {
	return author$project$Main$basicLayout(
		A2(
			...
			_List_fromArray(
				[
					...
					{
						dp: mdgriffith$elm_ui$Element$text('Ignore'),
...
var author$project$Editor$frameIf = function (framed) {
	return framed ? _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Border$width(1),
			mdgriffith$elm_ui$Element$Border$color(author$project$Palette$monokai_white)
		]) : _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Border$width(1),
			mdgriffith$elm_ui$Element$Border$color(author$project$Palette$monokai_black)
		]);
};
var author$project$Editor$isEmptyNode = function (_n0) {
	var content = _n0.p;
	_n1$2:
	while (true) {
		switch (content.$) {
...
var author$project$Editor$Hover = 4;
var author$project$Editor$Unhover = 5;
var author$project$Palette$monokai_grey = A3(mdgriffith$elm_ui$Element$rgb255, 51, 52, 47);
...
var author$project$Editor$nodeAttributes = F3(
	function (hovered, marked, sid) {
		return _Utils_ap(
			...
			(marked || hovered) ? _List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(author$project$Palette$monokai_grey)
				]) : _List_Nil);
	});
var author$project$Editor$Collapse = 1;
var author$project$Editor$Frame = 8;
var author$project$Editor$Unframe = 9;
var author$project$Palette$actual_black = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0);
...
var author$project$Editor$viewCollapsable = F2(
					...
					_List_fromArray(
						[
							...
							author$project$Editor$Editor(
								{x: 9, w: sid})),
							mdgriffith$elm_ui$Element$pointer,
							mdgriffith$elm_ui$Element$Font$color(author$project$Palette$actual_black),
						...
						[
							...
							_List_fromArray(
								[
									...
									{cM: 0, a3: 0, dN: 1, eu: 0}),
									mdgriffith$elm_ui$Element$Border$color(author$project$Palette$actual_black)
								]),
...
var author$project$Editor$Expand = 0;
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bs: col, d: s0.d, e: s0.e, b: offset, b8: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.b8, s.bs, s);
	};
};
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bs: col, cW: contextStack, b_: problem, b8: row};
	});
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$DeadEnd, s.b8, s.bs, x, s.d));
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.b, s.b8, s.bs, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bs: newCol, d: s.d, e: s.e, b: newOffset, b8: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{bs: 1, d: s.d, e: s.e, b: s.b + 1, b8: s.b8 + 1, a: s.a}) : A3(
				elm$parser$Parser$Advanced$Good,
				true,
				0,
				{bs: s.bs + 1, d: s.d, e: s.e, b: newOffset, b8: s.b8, a: s.a}));
		};
	});
...
var author$project$SyntaxHighlight$Language$Helpers$delimitedUnnestable = F2(
	function (options, revAList) {
		var defaultMap = options.bu;
		var isNotRelevant = options.bM;
		var end = options.aZ;
		var innerParsers = options.bI;
...
var author$project$SyntaxHighlight$Language$Helpers$delimitedHelp = F2(
	function (options, revAList) {
		...
		var _n0 = _Utils_Tuple2(
			elm$core$String$uncons(options.bc),
...
var elm$parser$Parser$Advanced$keyword = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.b8, s.bs, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
...
var author$project$SyntaxHighlight$Line$Helpers$newLine = function (fragments) {
	return {bA: fragments, da: elm$core$Maybe$Nothing};
};
...
var author$project$SyntaxHighlight$Line$Helpers$toFragment = F2(
	function (toStyle, _n0) {
		...
		switch (syntax.$) {
			case 0:
				return {bj: _List_Nil, cq: '', dK: 0, ee: text};
			case 1:
				return {bj: _List_Nil, cq: '', dK: 1, ee: text};
			case 2:
				return {bj: _List_Nil, cq: '', dK: 0, ee: text};
			default:
				var c = syntax.a;
				...
				return {bj: _List_Nil, cq: additionalClass, dK: requiredStyle, ee: text};
		}
	});
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bs: col, b_: problem, b8: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.b8, p.bs, p.b_);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{bs: 1, d: _List_Nil, e: 1, b: 0, b8: 1, a: src});
		if (!_n1.$) {
			var value = _n1.b;
...
var author$project$SyntaxHighlight$View$fragmentView = function (_n0) {
	var text = _n0.ee;
	var requiredStyle = _n0.dK;
	var additionalClass = _n0.cq;
	var additionalAttributes = _n0.bj;
	...
	return A2(
		...
		elm$core$List$concat(
			A2(
				elm$core$List$map,
				function (_n0) {
					var highlight = _n0.da;
					var fragments = _n0.bA;
...
var author$project$EditorField$inlineSH = function (txt) {
...
var author$project$Palette$orange = A3(mdgriffith$elm_ui$Element$rgb255, 255, 133, 51);
var author$project$Editor$viewTeaser = function (content) {
	switch (content.$) {
		case 0:
			var sw = content.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$color(
								author$project$Slice$hasChanged(sw) ? author$project$Palette$orange : author$project$Palette$actual_black)
							]),
						mdgriffith$elm_ui$Element$text('⮟ ')),
						author$project$EditorField$inlineSH(sw.ed)
					]));
		case 1:
			var occs = content.a;
...
var author$project$Editor$viewCollapsedNode = function (_n0) {
	var marked = _n0.W;
	var id = _n0.j;
	var content = _n0.p;
	...
	return A2(
		...
		_Utils_ap(
			...
			_Utils_ap(
				marked ? _List_fromArray(
					[
						mdgriffith$elm_ui$Element$Background$color(author$project$Palette$monokai_grey)
					]) : _List_Nil,
				fontColor)),
		author$project$Editor$viewTeaser(content));
};
var author$project$Editor$Edit = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var author$project$Editor$Main = function (a) {
	return {$: 0, a: a};
};
var author$project$Editor$MakeEditable = 6;
var author$project$Editor$MakeStatic = 7;
var author$project$Editor$Mark = 2;
var author$project$Editor$Unmark = 3;
var mdgriffith$elm_ui$Element$rgba = mdgriffith$elm_ui$Internal$Model$Rgba;
var author$project$Palette$glass = A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0);
var mdgriffith$elm_ui$Internal$Flag$shadows = mdgriffith$elm_ui$Internal$Flag$flag(19);
var mdgriffith$elm_ui$Internal$Model$boxShadowClass = function (shadow) {
	return elm$core$String$concat(
		_List_fromArray(
			[
				shadow.bJ ? 'box-inset' : 'box-',
...
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {ad: almostShade.ad, ae: almostShade.ae, bJ: false, b: almostShade.b, ba: almostShade.ba};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var mdgriffith$elm_ui$Element$clip = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.cR);
...
var mdgriffith$elm_ui$Element$scrollbarY = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.dS);
...
var mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {cM: -box.cM, a3: -box.a3, dN: -box.dN, eu: -box.eu};
};
					...
					case 7:
						...
						if (isMultiline) {
							...
							var reducedVerticalPadding = mdgriffith$elm_ui$Element$paddingEach(
								{
									cM: b - A2(elm$core$Basics$min, t, b),
									a3: l,
									dN: r,
									eu: t - A2(elm$core$Basics$min, t, b)
								});
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{y: _List_Nil, f: _List_Nil, o: _List_Nil, c: _List_Nil, ar: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.bT + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dH)),
...
var mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			mdgriffith$elm_ui$Element$Input$isStacked(textOptions.dp),
			withDefaults);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.dp),
					...
					_Utils_ap(
						(heightConstrained ? elm$core$List$cons(mdgriffith$elm_ui$Element$scrollbarY) : elm$core$Basics$identity)(
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
									A2(elm$core$List$any, mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? mdgriffith$elm_ui$Internal$Model$NoAttribute : mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.by),
									...
									function () {
										if (textOptions.ee === '') {
											...
											if (_n1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3(mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.ee === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.dj)
															]),
														_List_fromArray(
															[
										...
										if (_n2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3(mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.y, textOptions.ee === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				elm$core$List$cons,
				A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$cursor, mdgriffith$elm_ui$Internal$Style$classes.cY),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.dp) ? mdgriffith$elm_ui$Internal$Model$NoAttribute : mdgriffith$elm_ui$Element$spacing(5),
...
var mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{D: elm$core$Maybe$Nothing, F: multi.d_, r: mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{dp: multi.dp, dx: multi.dx, dI: multi.dI, ee: multi.ee});
	});
var author$project$EditorField$invisibleTextarea = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
					mdgriffith$elm_ui$Element$Background$color(author$project$Palette$glass),
					mdgriffith$elm_ui$Element$Font$color(author$project$Palette$glass),
					mdgriffith$elm_ui$Element$spacing(0),
					mdgriffith$elm_ui$Element$padding(0),
					mdgriffith$elm_ui$Element$Border$rounded(0),
					mdgriffith$elm_ui$Element$Border$width(0),
					A2(mdgriffith$elm_ui$Element$Border$glow, author$project$Palette$glass, 0.0)
				]),
			{
				dp: mdgriffith$elm_ui$Element$Input$labelHidden(
...
var author$project$Palette$edges = {cM: 0, a3: 0, dN: 0, eu: 0};
		...
		return A2(
			...
			function (l) {
				return _Utils_update(
					l,
					{
						bA: A2(elm$core$List$map, f, l.bA)
					});
			},
			lines);
	});
var author$project$SyntaxHighlight$dictAddAttributes = function (dict) {
	return author$project$SyntaxHighlight$mapFragments(
		function (frag) {
			var _n0 = A2(elm$core$Dict$get, frag.ee, dict);
			if (_n0.$ === 1) {
				return frag;
			} else {
				var attrs = _n0.a;
				return _Utils_update(
					frag,
					{
						bj: _Utils_ap(attrs, frag.bj)
					});
			}
		});
};
var elm$core$String$endsWith = _String_endsWith;
var author$project$EditorField$syntaxHighlight = F2(
	function (txt, dict) {
		return function (result) {
			if (!result.$) {
				var a = result.a;
...
var author$project$EditorField$editorField = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(author$project$EditorField$invisibleTextarea, txt, onChange))
				]),
			A2(author$project$EditorField$syntaxHighlight, txt, dict));
	});
var mdgriffith$elm_ui$Element$spaceEvenly = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$spacing, mdgriffith$elm_ui$Internal$Style$classes.dY);
...
var author$project$Editor$viewSlice = F3(
	function (sw, editable, nodeId) {
		var renderedFragment = author$project$Slice$renderFragment(sw.bb);
					...
					function (mid) {
						return _List_fromArray(
							[
								...
								author$project$Editor$Editor(
									{x: 2, w: nodeId + ('dep' + mid)})),
								elm$html$Html$Events$onMouseLeave(
								author$project$Editor$Editor(
									{x: 3, w: nodeId + ('dep' + mid)})),
								elm$html$Html$Attributes$class('reference')
							]);
					}),
				author$project$Slice$extractReferences(sw.bb)));
		var dirtyAttribs = author$project$Slice$hasChanged(sw) ? _List_fromArray(
			[
				mdgriffith$elm_ui$Element$Border$widthEach(
				_Utils_update(
					author$project$Palette$edges,
					{a3: 1})),
				mdgriffith$elm_ui$Element$Border$color(author$project$Palette$orange)
			]) : _List_Nil;
		return editable ? A2(
			mdgriffith$elm_ui$Element$row,
			dirtyAttribs,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Border$width(1),
							mdgriffith$elm_ui$Element$Border$color(author$project$Palette$monokai_grey)
						]),
					A3(
						author$project$EditorField$editorField,
						renderedFragment,
						function (txt) {
							return author$project$Editor$Main(
								A2(author$project$Editor$Edit, txt, sw));
						},
						highlightDict)),
					A2(
					mdgriffith$elm_ui$Element$el,
			...
			_Utils_ap(
				...
				dirtyAttribs),
			A2(author$project$EditorField$syntaxHighlight, renderedFragment, highlightDict));
	});
var author$project$Editor$viewListNode = F2(
	function (nodes, _n8) {
		var hovered = _n8.ai;
		var marked = _n8.W;
		var framed = _n8.ag;
		...
		return A2(
			mdgriffith$elm_ui$Element$el,
			author$project$Editor$frameIf(framed),
			A2(
				author$project$Editor$viewCollapsable,
				id,
				A2(
					mdgriffith$elm_ui$Element$column,
					_List_fromArray(
					...
					A2(elm$core$List$map, author$project$Editor$viewNode, nodes))));
	});
var author$project$Editor$viewNode = function (node) {
	var _n6 = node.i;
	if (!_n6.$) {
		return author$project$Editor$viewCollapsedNode(node);
	} else {
		var children = _n6.a;
		var _n7 = node.p;
		switch (_n7.$) {
			case 0:
				var sw = _n7.a;
				return A2(author$project$Editor$viewSliceNode, sw, node);
			case 1:
				var occs = _n7.a;
				return A2(author$project$Editor$viewListNode, children, node);
			default:
				var deps = _n7.a;
				return A2(author$project$Editor$viewListNode, children, node);
		}
...
var author$project$Editor$viewSliceNode = F2(
	function (sw, _n0) {
		var hovered = _n0.ai;
		var marked = _n0.W;
		var id = _n0.j;
		...
		if (((children.$ === 1) && children.a.b) && children.a.b.b) {
			...
			var viewIfNotEmpty = function (n) {
				return author$project$Editor$isEmptyNode(n) ? _List_Nil : _List_fromArray(
					[
						author$project$Editor$viewNode(n)
					]);
			};
			var _n4 = (hovered || editable) ? _Utils_Tuple2(
				_Utils_eq(occs.i, author$project$Editor$Collapsed) ? viewIfNotEmpty(occs) : _List_Nil,
				_Utils_eq(deps.i, author$project$Editor$Collapsed) ? viewIfNotEmpty(deps) : _List_Nil) : _Utils_Tuple2(_List_Nil, _List_Nil);
			var smallOccs = _n4.a;
			var smallDeps = _n4.b;
			var _n5 = _Utils_Tuple2(
				(!_Utils_eq(occs.i, author$project$Editor$Collapsed)) ? viewIfNotEmpty(occs) : _List_Nil,
				(!_Utils_eq(deps.i, author$project$Editor$Collapsed)) ? viewIfNotEmpty(deps) : _List_Nil);
			var bigOccs = _n5.a;
			var bigDeps = _n5.b;
			return A2(
				mdgriffith$elm_ui$Element$el,
								...
								_List_fromArray(
									[
										...
										A2(
											elm$core$List$cons,
											mdgriffith$elm_ui$Element$spacing(8),
											A3(author$project$Editor$nodeAttributes, hovered, marked, id)),
										_Utils_ap(
											smallOccs,
											_Utils_ap(
												_List_fromArray(
													[
														A3(author$project$Editor$viewSlice, sw, editable, id)
													]),
												smallDeps)))
									]),
								bigDeps)))));
...
var author$project$Main$Save = {$: 7};
var mdgriffith$elm_ui$Internal$Model$Right = 2;
var mdgriffith$elm_ui$Element$alignRight = mdgriffith$elm_ui$Internal$Model$AlignX(2);
var author$project$Main$viewToolbar = function (saving) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$padding(10),
						mdgriffith$elm_ui$Element$Events$onClick(author$project$Main$Save),
						mdgriffith$elm_ui$Element$mouseOver(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Background$color(author$project$Palette$monokai_grey)
...
var mdgriffith$elm_ui$Element$scrollbars = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.dQ);
...
var author$project$Main$viewEditor = F2(
	function (node, saving) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					author$project$Main$viewToolbar(saving),
					A2(
					mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					A2(
						...
						author$project$Editor$viewNode(node)))
				]));
	});
var author$project$Main$viewLoading = function (msgs) {
	return author$project$Main$basicLayout(
		A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			A2(elm$core$List$map, mdgriffith$elm_ui$Element$text, msgs)));
};
var author$project$Main$viewPage = function (_n0) {
	...
	if (page.$ === 1) {
		var node = page.a;
		return A2(author$project$Main$viewEditor, node, saving);
	} else {
		var msgs = page.a;
		return author$project$Main$viewLoading(msgs);
	}
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bz: fragment, bF: host, bX: path, bZ: port_, b1: protocol, b2: query};
	});
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		dh: author$project$Main$init,
		ec: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		ey: author$project$Main$update,
		ez: author$project$Main$view
	});
