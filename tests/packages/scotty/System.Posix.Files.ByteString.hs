...
{-# LINE 33 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 82 "System/Posix/Files/ByteString.hsc" #-}
    setSymbolicLinkOwnerAndGroup,

{-# LINE 84 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 141 "System/Posix/Files/ByteString.hsc" #-}
   write_f = if writeOK then (2) else 0
{-# LINE 142 "System/Posix/Files/ByteString.hsc" #-}
   exec_f  = if execOK  then (1) else 0
{-# LINE 143 "System/Posix/Files/ByteString.hsc" #-}
...
fileExist name =
  withFilePath name $ \s -> do
    r <- c_access s (0)
{-# LINE 151 "System/Posix/Files/ByteString.hsc" #-}
    if (r == 0)
        then return True
...
{-# LINE 178 "System/Posix/Files/ByteString.hsc" #-}
  withForeignPtr fp $ \p ->
    withFilePath path $ \s ->
...
getSymbolicLinkStatus path = do
  fp <- mallocForeignPtrBytes (144)
{-# LINE 191 "System/Posix/Files/ByteString.hsc" #-}
  withForeignPtr fp $ \p ->
    withFilePath path $ \s ->
...
{-# LINE 275 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 282 "System/Posix/Files/ByteString.hsc" #-}
    withFilePath file $ \s -> do
      len <- throwErrnoPathIfMinus1 "readSymbolicLink" file $
        c_readlink s buf (4096)
{-# LINE 285 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 336 "System/Posix/Files/ByteString.hsc" #-}
...
setFileTimes name atime mtime = do
  withFilePath name $ \s ->
   allocaBytes (16) $ \p -> do
{-# LINE 348 "System/Posix/Files/ByteString.hsc" #-}
     ((\hsc_ptr -> pokeByteOff hsc_ptr 0))  p atime
{-# LINE 349 "System/Posix/Files/ByteString.hsc" #-}
     ((\hsc_ptr -> pokeByteOff hsc_ptr 8)) p mtime
{-# LINE 350 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 362 "System/Posix/Files/ByteString.hsc" #-}

{-# LINE 368 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 381 "System/Posix/Files/ByteString.hsc" #-}

{-# LINE 391 "System/Posix/Files/ByteString.hsc" #-}
...
{-# LINE 415 "System/Posix/Files/ByteString.hsc" #-}
