...
instance (Monoid w, MonadResource m) => MonadResource ( WriterT w m) where liftResourceT = lift . liftResourceT
instance (Monoid w, MonadResource m) => MonadResource ( RWST r w s m) where liftResourceT = lift . liftResourceT
