{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/SharedMem.hs" #-}
...
{-# LINE 2 "dist/dist-sandbox-235ea54e/build/System/Posix/SharedMem.hs" #-}
{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/SharedMem.hs" #-}
...
{-# LINE 23 "System/Posix/SharedMem.hsc" #-}

{-# LINE 24 "System/Posix/SharedMem.hsc" #-}
...
{-# LINE 30 "System/Posix/SharedMem.hsc" #-}
import Foreign.C

{-# LINE 32 "System/Posix/SharedMem.hsc" #-}

{-# LINE 33 "System/Posix/SharedMem.hsc" #-}
import Data.Bits
...
{-# LINE 50 "System/Posix/SharedMem.hsc" #-}
shmOpen name flags mode =
    do cflags0 <- return 0
       cflags1 <- return $ cflags0 .|. (if shmReadWrite flags
                                        then 2
{-# LINE 54 "System/Posix/SharedMem.hsc" #-}
                                        else 0)
{-# LINE 55 "System/Posix/SharedMem.hsc" #-}
...
{-# LINE 56 "System/Posix/SharedMem.hsc" #-}
       ...
       cflags3 <- return $ cflags2 .|. (if shmExclusive flags 
                                        then 128 
{-# LINE 59 "System/Posix/SharedMem.hsc" #-}
                                        else 0)
...
{-# LINE 85 "System/Posix/SharedMem.hsc" #-}
...
{-# LINE 90 "System/Posix/SharedMem.hsc" #-}
