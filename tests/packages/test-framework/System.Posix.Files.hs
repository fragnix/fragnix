{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/Files.hs" #-}
...
{-# LINE 2 "dist/dist-sandbox-235ea54e/build/System/Posix/Files.hs" #-}
{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/Files.hs" #-}
...
{-# LINE 29 "System/Posix/Files.hsc" #-}
...
{-# LINE 78 "System/Posix/Files.hsc" #-}
    setSymbolicLinkOwnerAndGroup,

{-# LINE 80 "System/Posix/Files.hsc" #-}
...
{-# LINE 131 "System/Posix/Files.hsc" #-}
   write_f = if writeOK then (2) else 0
{-# LINE 132 "System/Posix/Files.hsc" #-}
   exec_f  = if execOK  then (1) else 0
{-# LINE 133 "System/Posix/Files.hsc" #-}
...
fileExist name =
  withFilePath name $ \s -> do
    r <- c_access s (0)
{-# LINE 141 "System/Posix/Files.hsc" #-}
    if (r == 0)
        then return True
...
{-# LINE 167 "System/Posix/Files.hsc" #-}
  withForeignPtr fp $ \p ->
    withFilePath path $ \s ->
...
{-# LINE 264 "System/Posix/Files.hsc" #-}
...
{-# LINE 271 "System/Posix/Files.hsc" #-}
    withFilePath file $ \s -> do
      len <- throwErrnoPathIfMinus1 "readSymbolicLink" file $
        c_readlink s buf (4096)
{-# LINE 274 "System/Posix/Files.hsc" #-}
...
{-# LINE 312 "System/Posix/Files.hsc" #-}
...
{-# LINE 325 "System/Posix/Files.hsc" #-}
...
setFileTimes name atime mtime = do
  withFilePath name $ \s ->
   allocaBytes (16) $ \p -> do
{-# LINE 337 "System/Posix/Files.hsc" #-}
     ((\hsc_ptr -> pokeByteOff hsc_ptr 0))  p atime
{-# LINE 338 "System/Posix/Files.hsc" #-}
     ((\hsc_ptr -> pokeByteOff hsc_ptr 8)) p mtime
{-# LINE 339 "System/Posix/Files.hsc" #-}
...
{-# LINE 348 "System/Posix/Files.hsc" #-}
...
{-# LINE 359 "System/Posix/Files.hsc" #-}
...
{-# LINE 369 "System/Posix/Files.hsc" #-}
