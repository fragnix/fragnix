{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/Temp.hs" #-}
...
{-# LINE 2 "dist/dist-sandbox-235ea54e/build/System/Posix/Temp.hs" #-}
{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/Temp.hs" #-}
...
{-# LINE 24 "System/Posix/Temp.hsc" #-}

import Foreign.C
import System.IO

{-# LINE 30 "System/Posix/Temp.hsc" #-}
import System.Posix.IO
import System.Posix.Types
import System.Posix.Internals (withFilePath, peekFilePath)


{-# LINE 38 "System/Posix/Temp.hsc" #-}
...
{-# LINE 105 "System/Posix/Temp.hsc" #-}
  withFilePath template $ \ ptr -> do
    _ <- throwErrnoIfNull "mkdtemp" (c_mkdtemp ptr)
    name <- peekFilePath ptr
    return name

{-# LINE 114 "System/Posix/Temp.hsc" #-}
...
{-# LINE 129 "System/Posix/Temp.hsc" #-}
