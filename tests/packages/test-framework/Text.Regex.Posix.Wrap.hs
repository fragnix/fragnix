{-# LINE 1 "dist/dist-sandbox-235ea54e/build/Text/Regex/Posix/Wrap.hs" #-}
...
{-# LINE 2 "dist/dist-sandbox-235ea54e/build/Text/Regex/Posix/Wrap.hs" #-}
{-# LINE 1 "dist/dist-sandbox-235ea54e/build/Text/Regex/Posix/Wrap.hs" #-}
...
{-# LINE 138 "Text/Regex/Posix/Wrap.hsc" #-}
...
{-# LINE 191 "Text/Regex/Posix/Wrap.hsc" #-}
...
{-# LINE 226 "Text/Regex/Posix/Wrap.hsc" #-}
...
{-# LINE 375 "Text/Regex/Posix/Wrap.hsc" #-}
