{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/Semaphore.hs" #-}
...
{-# LINE 2 "dist/dist-sandbox-235ea54e/build/System/Posix/Semaphore.hs" #-}
{-# LINE 1 "dist/dist-sandbox-235ea54e/build/System/Posix/Semaphore.hs" #-}
...
{-# LINE 25 "System/Posix/Semaphore.hsc" #-}

{-# LINE 26 "System/Posix/Semaphore.hsc" #-}
...
{-# LINE 52 "System/Posix/Semaphore.hsc" #-}
                 (if semExclusive flags then 128 else 0)
{-# LINE 53 "System/Posix/Semaphore.hsc" #-}
        semOpen' cname =
