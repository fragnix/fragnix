...
import GHC.Tuple ()
import GHC.Prim (Char#, Int#, Word#, Float#, Double#, Word64#, State#, MutableArray#, Array#, MutableByteArray#, ByteArray#, Addr#, StablePtr#, Int64#, MutableArrayArray#, ArrayArray#, MutVar#, RealWorld, TVar#, MVar#, ThreadId#, Weak#, StableName#, BCO#)
{-# NOINLINE gtChar# #-}
