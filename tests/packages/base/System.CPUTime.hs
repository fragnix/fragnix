...
{-# LINE 1 "dist/dist-sandbox-d76e0d17/build/System/CPUTime.hs" #-}
...
{-# LINE 40 "System/CPUTime.hsc" #-}

-- For FILETIME etc. on Windows

{-# LINE 45 "System/CPUTime.hsc" #-}

-- for struct tms

{-# LINE 48 "System/CPUTime.hsc" #-}

{-# LINE 49 "System/CPUTime.hsc" #-}
...
{-# LINE 117 "System/CPUTime.hsc" #-}


{-# LINE 151 "System/CPUTime.hsc" #-}
