...
minIntAsBig :: Integer
minIntAsBig = case int2Integer# (-9223372036854775808#) of { (# s, d #) -> J# s d }
...
quotRemInteger (S# (-9223372036854775808#)) b = quotRemInteger minIntAsBig b
...
divModInteger (S# (-9223372036854775808#)) b = divModInteger minIntAsBig b
...
remInteger (S# (-9223372036854775808#)) b = remInteger minIntAsBig b
...
quotInteger (S# (-9223372036854775808#)) b = quotInteger minIntAsBig b
...
modInteger (S# (-9223372036854775808#)) b = modInteger minIntAsBig b
...
divInteger (S# (-9223372036854775808#)) b = divInteger minIntAsBig b
...
gcdInteger (S# (-9223372036854775808#)) b = gcdInteger minIntAsBig b
gcdInteger a (S# (-9223372036854775808#)) = gcdInteger a minIntAsBig
...
divExact (S# (-9223372036854775808#)) b = divExact minIntAsBig b
...
absInteger (S# (-9223372036854775808#)) = (S# 9223372036854775807# `plusInteger` S# 1#)
...
negateInteger (S# (-9223372036854775808#)) = (S# 9223372036854775807# `plusInteger` S# 1#)
