...
{-# LINE 1 "dist/dist-sandbox-d76e0d17/build/GHC/Event/EPoll.hs" #-}
{-# LINE 1 "GHC/Event/EPoll.hsc" #-}
{-# LANGUAGE Trustworthy #-}
{-# LINE 2 "GHC/Event/EPoll.hsc" #-}
...
{-# LINE 28 "GHC/Event/EPoll.hsc" #-}

{-# LINE 38 "GHC/Event/EPoll.hsc" #-}


{-# LINE 40 "GHC/Event/EPoll.hsc" #-}
